...
"numfeeders_suet",
"squirrels",
"loc_id", # I can't use this because it's a character, not a factor.
"proj_period_id") #numfeeders_suet
...
clean_dataset3 <- new_clean_dataset2[, -22, ] #(19,940 × 21)
# The above removes "PFW_[year]"
clean_dataset3

clean_dataset3$count_area_size_sq_m_atleast <- as.integer(clean_dataset3$count_area_size_sq_m_atleast) # (decimals -> integers)
clean_dataset3
