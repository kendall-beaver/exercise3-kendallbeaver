...
no_na_values_dataset2 #121,918 x 22 columns
no_na_values_dataset2 |> summary()

library(writexl)
write_xlsx(no_na_values_dataset2, path = "dataset2_clean.xlsx")

birdfeeder_count <- c(0:14, 16, 22)
birdfeeder_count
no_of_birdfeeder_elements <- length(birdfeeder_count)
no_of_birdfeeder_elements # There's 17 elements that need to be divided by 3...
